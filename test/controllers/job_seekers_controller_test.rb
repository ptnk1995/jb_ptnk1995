...
class JobSeekersControllerTest < ActionController::TestCase
  ...
  test "should create job_seeker" do
    assert_difference('JobSeeker.count') do
      post :create, job_seeker: { expected_locations: @job_seeker.expected_locations, expected_sal: @job_seeker.expected_sal, skills: @job_seeker.skills, user: @job_seeker.user }
    end
  ...
  test "should update job_seeker" do
    patch :update, id: @job_seeker, job_seeker: { expected_locations: @job_seeker.expected_locations, expected_sal: @job_seeker.expected_sal, skills: @job_seeker.skills, user: @job_seeker.user }
    assert_redirected_to job_seeker_path(assigns(:job_seeker))
  end
