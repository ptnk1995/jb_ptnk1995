...
class UserEmailsControllerTest < ActionController::TestCase
  ...
  test "should create user_email" do
    assert_difference('UserEmail.count') do
      post :create, user_email: { email: @user_email.email, is_default: @user_email.is_default, user_id: @user_email.user_id }
    end
  ...
  test "should update user_email" do
    patch :update, id: @user_email, user_email: { email: @user_email.email, is_default: @user_email.is_default, user_id: @user_email.user_id }
    assert_redirected_to user_email_path(assigns(:user_email))
  end
